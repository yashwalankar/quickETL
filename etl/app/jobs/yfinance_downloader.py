"""
Downloads OHLCV Data from yfinance API


Example job_config JSON:
{
    "symbol": "AAPL",              // Stock symbol (default: "SPY")
    "interval": "1h",              // Data interval: 1m, 2m, 5m, 15m, 30m, 60m, 90m, 1h, 1d, 5d, 1wk, 1mo, 3mo (default: "1d")
    "period": "6mo",               // Data period: 1d, 5d, 1mo, 3mo, 6mo, 1y, 2y, 5y, 10y, ytd, max (default: "1y")
    "auto_adjust": false,          // Whether to auto-adjust OHLC data for dividends/splits (default: true)
    "include_prepost": true,       // Include pre/post market data (default: false)
    "output_dir": "/custom/path",  // Directory to save output files (default: "/app/data/stocks")
    "filename": "custom_name.csv", // Custom filename for output (default: null - auto-generated)
    "save_stats": true             // Save additional statistics file (default: false)
}
...
def download_stock_data(symbol, interval, period, auto_adjust=True,
                       include_prepost=False, output_dir='/app/data/stocks',
...
def main():
    ...
    output_dir = job_config.get('output_dir', '/app/data/stocks')
